...
PICKUP_COMMON_ITEMS = [
  :POTION,        # Levels 1-10
  :SUPERPOTION,   # Levels 1-10, 11-20
  :GREATBALL,     # Levels 1-10, 11-20, 21-30
  :GREENUFO,      # Levels 1-10, 11-20, 21-30, 31-40
  :ETHER,         # Levels 1-10, 11-20, 21-30, 31-40, 41-50
  :FULLHEAL,      # Levels 1-10, 11-20, 21-30, 31-40, 41-50, 51-60
  :ULTRABALL,     # Levels 1-10, 11-20, 21-30, 31-40, 41-50, 51-60, 61-70
  :HYPERPOTION,   # Levels 1-10, 11-20, 21-30, 31-40, 41-50, 51-60, 61-70, 71-80
  :RARECANDY,     # Levels 1-10, 11-20, 21-30, 31-40, 41-50, 51-60, 61-70, 71-80, 81-90
  :BLUEUFO,       # Levels       11-20, 21-30, 31-40, 41-50, 51-60, 61-70, 71-80, 81-90, 91-100
  :HPUP,          # Levels              21-30, 31-40, 41-50, 51-60, 61-70, 71-80, 81-90, 91-100
  :PROTEIN,       # Levels                     31-40, 41-50, 51-60, 61-70, 71-80, 81-90, 91-100
  :IRON,          # Levels                            41-50, 51-60, 61-70, 71-80, 81-90, 91-100
  :CARBOS,        # Levels                                   51-60, 61-70, 71-80, 81-90, 91-100
  :CALCIUM,       # Levels                                          61-70, 71-80, 81-90, 91-100
  :ZINC,          # Levels                                                 71-80, 81-90, 91-100
  :PPUP,          # Levels                                                        81-90, 91-100
  :MAXREVIVE      # Levels                                                               91-100
]
...
# num_rarity_levels is in def pbPickup below.
PICKUP_RARE_ITEMS = [
  :FULLRESTORE,   # Levels 1-10
  :NUGGET,        # Levels 1-10, 11-20
  :KINGSROCK,     # Levels       11-20, 21-30
  :LEFTOVERS,     # Levels              21-30, 31-40
  :BRIGHTPOWDER,  # Levels                     31-40, 41-50
  :WHITEHERB,     # Levels                            41-50, 51-60
  :MAXELIXIR,     # Levels                                   51-60, 61-70
  :CHROMESHARD,   # Levels                                          61-70, 71-80
  :DESTINYKNOT,   # Levels                                                 71-80, 81-90
  :PPMAX,         # Levels                                                        81-90, 91-100
