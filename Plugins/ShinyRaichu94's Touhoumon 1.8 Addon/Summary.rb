...
class PokemonSummary_Scene
  ...
  def drawPage(page)
    ...
    if @EVandIV
        skillpagename = _INTL("EVS & IVS")
    else
        skillpagename = _INTL("SKILLS")
    end
    pagename = [_INTL("INFO"),
                _INTL("TRAINER MEMO"),
                skillpagename,
  ...
  def drawPageThree
    ...
    textpos = [
      ...
      [sprintf("%d/%d", @pokemon.ev[:HP], @pokemon.iv[:HP]), 462, 82, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [_INTL("Attack"), 248, 126, :left, base, statshadows[:ATTACK]],
      [sprintf("%d/%d", @pokemon.ev[:ATTACK], @pokemon.iv[:ATTACK]), 456, 126, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [_INTL("Defense"), 248, 158, :left, base, statshadows[:DEFENSE]],
      [sprintf("%d/%d", @pokemon.ev[:DEFENSE], @pokemon.iv[:DEFENSE]), 456, 158, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [_INTL("Sp. Atk"), 248, 190, :left, base, statshadows[:SPECIAL_ATTACK]],
      [sprintf("%d/%d", @pokemon.ev[:SPECIAL_ATTACK], @pokemon.iv[:SPECIAL_ATTACK]), 456, 190, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [_INTL("Sp. Def"), 248, 222, :left, base, statshadows[:SPECIAL_DEFENSE]],
      [sprintf("%d/%d", @pokemon.ev[:SPECIAL_DEFENSE], @pokemon.iv[:SPECIAL_DEFENSE]), 456, 222, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [_INTL("Speed"), 248, 254, :left, base, statshadows[:SPEED]],
      [sprintf("%d/%d", @pokemon.ev[:SPEED], @pokemon.iv[:SPEED]), 456, 254, :right, Color.new(64, 64, 64), Color.new(176, 176, 176)],
