...
module Settings
  ...
  DAY_CARE_POKEMON_CAN_SHARE_EGG_MOVES       = false
...
#    ["Deutsch", "deutsch"]
  ...
  def self.game_credits
    return [
      ...
      "ShinyRaichu94",
      "",
      _INTL("Overworld Sprites:"),
      "Hemoglobin_A1C<s>Renko and Maribel sprites",
      "Avatar, Kalarie, MrDollSteak, and Spherical Ice<s>Various NPC sprites",
      _INTL("Other Sprites:"),
