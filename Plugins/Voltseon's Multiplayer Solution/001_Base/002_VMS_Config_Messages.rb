module VMS
  ...
  SELECT_PARTY_SIZE_MESSAGE = _INTL("Select the number of Puppets to use:")
  # Party size options.
  PARTY_SIZE_3 = _INTL("3 Puppets")
  PARTY_SIZE_4 = _INTL("4 Puppets")
  PARTY_SIZE_6 = _INTL("6 Puppets")
  # Message displayed when a player doesn't have enough Pokémon for the selected size.
  NOT_ENOUGH_POKEMON_MESSAGE = _INTL("One of the players doesn't have enough Puppets for this battle size.")
  ...
  NO_TRADABLE_MESSAGE = _INTL("You lack any tradable Puppets.")
  ...
  OTHER_NO_TRADABLE_MESSAGE = _INTL("{1} has no tradable Puppets.")
  # Message displayed when waiting for the other player to confirm a trade. {1} is the name of the player waiting.
  TRADE_WAIT_CONFIRM_MESSAGE = _INTL("Waiting for {1} to select a Puppet...")
